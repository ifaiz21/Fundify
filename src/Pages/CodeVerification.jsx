...
const CodeVerificationPage = () => { 
    ...
    const handleVerify = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("https://fundify-server.vercel.app/api/auth/code-verification", {
                email,
                code,
            });
    ...
    const handleResendCode = async () => {
        try {
            ...
            // Using axios for API call
            const response = await axios.post("https://fundify-server.vercel.app/api/auth/resend-code", {
                email,
            });
