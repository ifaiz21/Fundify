// src/Pages/CampaignsCreation/CampSubmission.jsx
"use client"
      ...
      <div className="flex flex-row h-screen max-h-full">
        <div className="w-full h-full text-white flex flex-col items-center justify-center relative">
          <div className="h-screen pt-24 z-10">
            <img src={`/Images/login image1.png`}  alt="Success illustration" className="h-2/3 w-auto z-10" />
          </div>
          <div className="absolute bottom-6 z-50 text-center space-y-4">
            <h1 className="font-Inter font-bold text-4xl">Your Campaign has been submitted for Verification</h1>
